...
mixin _$HatPayload {
 ...
 String get hat;
/// Create a copy of HatPayload
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$HatPayloadCopyWith<HatPayload> get copyWith => _$HatPayloadCopyWithImpl<HatPayload>(this as HatPayload, _$identity);

  /// Serializes this HatPayload to a JSON map.
  Map<String, dynamic> toJson();


@override
bool operator ==(Object other) {
  final _this = this as HatPayload;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is HatPayload&&(identical(other.hat, _this.hat) || other.hat == _this.hat));
}
...
int get hashCode {
  final _this = this as HatPayload;
  return Object.hash(runtimeType,_this.hat);
}

@override
String toString() {
  final _this = this as HatPayload;
  return 'HatPayload(hat: ${_this.hat})';
}
...
/// @nodoc
abstract mixin class $HatPayloadCopyWith<$Res>  {
  factory $HatPayloadCopyWith(HatPayload value, $Res Function(HatPayload) _then) = _$HatPayloadCopyWithImpl;
@useResult
$Res call({
 String hat
});
...
/// @nodoc
class _$HatPayloadCopyWithImpl<$Res>
    implements $HatPayloadCopyWith<$Res> {
  _$HatPayloadCopyWithImpl(this._self, this._then);

  final HatPayload _self;
  final $Res Function(HatPayload) _then;

/// Create a copy of HatPayload
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? hat = null,}) {
  return _then(HatPayload(
hat: null == hat ? _self.hat : hat // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
...
/// Adds pattern-matching-related methods to [HatPayload].
extension HatPayloadPatterns on HatPayload {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _HatPayload value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _HatPayload() when $default != null:
return $default(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _HatPayload value)  $default,){
final _that = this;
switch (_that) {
case _HatPayload():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _HatPayload value)?  $default,){
final _that = this;
switch (_that) {
case _HatPayload() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String hat)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _HatPayload() when $default != null:
return $default(_that.hat);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String hat)  $default,) {final _that = this;
switch (_that) {
case _HatPayload():
return $default(_that.hat);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String hat)?  $default,) {final _that = this;
switch (_that) {
case _HatPayload() when $default != null:
return $default(_that.hat);case _:
  return null;
...
class _HatPayload implements HatPayload {
  const _HatPayload({required this.hat});
  factory _HatPayload.fromJson(Map<String, dynamic> json) => _$HatPayloadFromJson(json);

@override final  String hat;

/// Create a copy of HatPayload
/// with the given fields replaced by the non-null parameter values.
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$HatPayloadCopyWith<_HatPayload> get copyWith => __$HatPayloadCopyWithImpl<_HatPayload>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$HatPayloadToJson(this, );
}

@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is _HatPayload&&(identical(other.hat, hat) || other.hat == hat));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode {
    return Object.hash(runtimeType,hat);
}

@override
String toString() {
    return 'HatPayload(hat: $hat)';
}
...
/// @nodoc
abstract mixin class _$HatPayloadCopyWith<$Res> implements $HatPayloadCopyWith<$Res> {
  factory _$HatPayloadCopyWith(_HatPayload value, $Res Function(_HatPayload) _then) = __$HatPayloadCopyWithImpl;
@override @useResult
$Res call({
 String hat
});
...
/// @nodoc
class __$HatPayloadCopyWithImpl<$Res>
    implements _$HatPayloadCopyWith<$Res> {
  __$HatPayloadCopyWithImpl(this._self, this._then);

  final _HatPayload _self;
  final $Res Function(_HatPayload) _then;

/// Create a copy of HatPayload
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? hat = null,}) {
  return _then(_HatPayload(
hat: null == hat ? _self.hat : hat // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
...
@JsonKey(includeIfNull: false) String? get account;/// The seat is played by a program. Declared by whoever joined; nobody
/// checks it. Absent for a person.
@JsonKey(includeIfNull: false) bool? get bot; int get stack; String get status; bool get connected; bool get inHand; bool get folded; bool get allIn; int get betThisStreet; int get totalBet;@JsonKey(includeIfNull: false) List<String>? get holeCards; LastAction? get lastAction;/// A fully revealed hand described against the current board (follows
...
int get hashCode {
  final _this = this as PlayerView;
  return Object.hashAll([runtimeType,_this.id,_this.name,_this.avatar,_this.hat,_this.heat,_this.voice,_this.muted,_this.mucked,_this.camera,_this.equity,_this.timeBank,_this.place,_this.account,_this.bot,_this.stack,_this.status,_this.connected,_this.inHand,_this.folded,_this.allIn,_this.betThisStreet,_this.totalBet,const DeepCollectionEquality().hash(_this.holeCards),_this.lastAction,_this.handDescription,const DeepCollectionEquality().hash(_this.bestCards)]);
}

@override
String toString() {
  final _this = this as PlayerView;
  return 'PlayerView(id: ${_this.id}, name: ${_this.name}, avatar: ${_this.avatar}, hat: ${_this.hat}, heat: ${_this.heat}, voice: ${_this.voice}, muted: ${_this.muted}, mucked: ${_this.mucked}, camera: ${_this.camera}, equity: ${_this.equity}, timeBank: ${_this.timeBank}, place: ${_this.place}, account: ${_this.account}, bot: ${_this.bot}, stack: ${_this.stack}, status: ${_this.status}, connected: ${_this.connected}, inHand: ${_this.inHand}, folded: ${_this.folded}, allIn: ${_this.allIn}, betThisStreet: ${_this.betThisStreet}, totalBet: ${_this.totalBet}, holeCards: ${_this.holeCards}, lastAction: ${_this.lastAction}, handDescription: ${_this.handDescription}, bestCards: ${_this.bestCards})';
}
...
/// Create a copy of PlayerView
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? avatar = null,Object? hat = freezed,Object? heat = freezed,Object? voice = null,Object? muted = freezed,Object? mucked = freezed,Object? camera = freezed,Object? equity = freezed,Object? timeBank = freezed,Object? place = freezed,Object? account = freezed,Object? bot = freezed,Object? stack = null,Object? status = null,Object? connected = null,Object? inHand = null,Object? folded = null,Object? allIn = null,Object? betThisStreet = null,Object? totalBet = null,Object? holeCards = freezed,Object? lastAction = freezed,Object? handDescription = freezed,Object? bestCards = freezed,}) {
  return _then(PlayerView(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,name: null == name ? _self.name : name // ignore: cast_nullable_to_non_nullable
as String,avatar: null == avatar ? _self.avatar : avatar // ignore: cast_nullable_to_non_nullable
as int,hat: freezed == hat ? _self.hat : hat // ignore: cast_nullable_to_non_nullable
as String?,heat: freezed == heat ? _self.heat : heat // ignore: cast_nullable_to_non_nullable
...
as String?,bot: freezed == bot ? _self.bot : bot // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _PlayerView() when $default != null:
return $default(_that.id,_that.name,_that.avatar,_that.hat,_that.heat,_that.voice,_that.muted,_that.mucked,_that.camera,_that.equity,_that.timeBank,_that.place,_that.account,_that.bot,_that.stack,_that.status,_that.connected,_that.inHand,_that.folded,_that.allIn,_that.betThisStreet,_that.totalBet,_that.holeCards,_that.lastAction,_that.handDescription,_that.bestCards);case _:
  return orElse();
...
@override@JsonKey(includeIfNull: false) final  String? hat;
/// Running hot: 1..3 for two, three, four or more hands won in a row;
/// absent otherwise.
@override@JsonKey(includeIfNull: false) final  int? heat;
...
/// The seat is played by a program. Declared by whoever joined; nobody
/// checks it. Absent for a person.
@override@JsonKey(includeIfNull: false) final  bool? bot;
...
@override
int get hashCode {
    return Object.hashAll([runtimeType,id,name,avatar,hat,heat,voice,muted,mucked,camera,equity,timeBank,place,account,bot,stack,status,connected,inHand,folded,allIn,betThisStreet,totalBet,const DeepCollectionEquality().hash(_holeCards),lastAction,handDescription,const DeepCollectionEquality().hash(_bestCards)]);
}

@override
String toString() {
    return 'PlayerView(id: $id, name: $name, avatar: $avatar, hat: $hat, heat: $heat, voice: $voice, muted: $muted, mucked: $mucked, camera: $camera, equity: $equity, timeBank: $timeBank, place: $place, account: $account, bot: $bot, stack: $stack, status: $status, connected: $connected, inHand: $inHand, folded: $folded, allIn: $allIn, betThisStreet: $betThisStreet, totalBet: $totalBet, holeCards: $holeCards, lastAction: $lastAction, handDescription: $handDescription, bestCards: $bestCards)';
}
